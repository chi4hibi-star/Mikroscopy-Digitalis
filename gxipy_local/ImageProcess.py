...
import gxipy_local
from gxipy_local.Exception import UnexpectedError
from gxipy_local.ImageProc import Utility
from gxipy_local.gxwrapper import *
from gxipy_local.dxwrapper import *
from gxipy_local.gxidef import *
from gxipy_local.ImageFormatConvert import *
from gxipy_local.ImageProcessConfig import *
from gxipy_local.Exception import *
import types
...
class ImageProcess:
    ...
    def __is_packed_pixel_format(self, pixel_format):
        ...
        if (pixel_format & PIXEL_MONO):
            if pixel_bit in (gxipy_local.GX_PIXEL_10BIT, gxipy_local.GX_PIXEL_12BIT, gxipy_local.GX_PIXEL_14BIT,):
                return True
